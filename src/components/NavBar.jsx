...
const NavBar = () => {
    ...
    return (
        <div className='flex relative items-center justify-between px-4 py-2 font-space'>
            ...
            {menubutton ?
                <div className='absolute flex flex-col lg:hidden  h-screen w-1/2 top-19 z-40 right-0 ml-5'>
                        <NavLink to={'/'} className=" bg-white text-xl font-semibold border-b-4 border-b-gray-100 p-4 ">Home</NavLink>
                        <NavLink to={'/about'} className="bg-white text-xl font-semibold border-b-4 border-b-gray-100 p-4 ">About</NavLink>
                        <NavLink to={'/service'} className="bg-white text-xl font-semibold border-b-4 border-b-gray-100 p-4 " >Service</NavLink>
                        <NavLink to={'/blog'} className="bg-white text-xl font-semibold border-b-4 border-b-gray-100 p-4 ">Blog</NavLink>
                        <NavLink to={'/contact'} className="bg-white text-xl font-semibold p-4 ">Contact</NavLink>
                </div>
                : ""}
                {
                    menubutton ?
                    <div className='absolute lg:hidden h-screen w-full bg-gray-100 inset-0 blur-lg z-30 right-0 top-18'></div>
                    :""
                }
